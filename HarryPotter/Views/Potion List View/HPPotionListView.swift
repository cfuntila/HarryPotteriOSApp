...
protocol HPPotionListViewDelegate: AnyObject {
    func didSelectPotion(_ potion: HPPotion)
}

final class HPPotionListView: UIView {
    
    //MARK: - Properties
    
    public weak var delegate: HPPotionListViewDelegate?
    
    private let viewModel = HPPotionListViewViewModel()
...
extension HPPotionListView: HPPotionListViewViewModelDelegate {
    func didSelectPotion(_ potion: HPPotion) {
